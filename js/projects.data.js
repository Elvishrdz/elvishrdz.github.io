    ...
    versions: [
      {
        ...
        media: {
          ...
          captions: [
            { es: "Inicio", en: "Home" },
            { es: "Agregar bebida", en: "Add drink" },
            { es: "Historial", en: "History" },
            { es: "Recordatorios", en: "Reminders" },
            { es: "Personalizar", en: "Customize" },
      ...
      },
      {
        ...
        media: {
          ...
          devices: [
            ...
            { kind: "phone", src: "assets/projects/drink-water/v2/phone/4.png", caption: { es: "Recordatorios", en: "Reminders" }, group: { es: "Teléfono", en: "Phone" } },
            { kind: "phone", src: "assets/projects/drink-water/v2/phone/5.png", caption: { es: "Ajustes", en: "Settings" }, group: { es: "Teléfono", en: "Phone" } },
            { kind: "tablet", src: "assets/projects/drink-water/v2/tablet/1.jpg", caption: { es: "Panel", en: "Dashboard" }, group: { es: "Tablet", en: "Tablet" } },
            { kind: "tablet", src: "assets/projects/drink-water/v2/tablet/2.jpg", caption: { es: "Dos paneles", en: "Two-pane" }, group: { es: "Tablet", en: "Tablet" } },
            ...
            { kind: "laptop", src: "assets/projects/drink-water/v2/laptop/1.png", caption: { es: "Inicio web", en: "Web home" }, group: { es: "Chromebook", en: "Chromebook" } },
            { kind: "laptop", src: "assets/projects/drink-water/v2/laptop/2.png", caption: { es: "Historial web", en: "Web history" }, group: { es: "Chromebook", en: "Chromebook" } },
          ],
        },
      },
    ],
